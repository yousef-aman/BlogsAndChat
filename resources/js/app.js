...
import helloVue from './Conponents/helloVue.vue'
import sideBar from './Conponents/sidebar.vue'
import About from './Conponents/About.vue'
import likeForm from './Conponents/likeForm.vue'
import publishPost from './Conponents/publishPost.vue'
import {createApp} from 'vue';
import chat from './Conponents/chat.vue'
import advChat from './Conponents/advChat.vue'
import newHeaderNotify from './Conponents/newHeaderNotify.vue'
...
app.component('likeForm',likeForm)
app.component('publishPost',publishPost)
app.component('chat-com',chat)
app.component('newHeaderNotify',newHeaderNotify)
app.component('advChat',advChat)
